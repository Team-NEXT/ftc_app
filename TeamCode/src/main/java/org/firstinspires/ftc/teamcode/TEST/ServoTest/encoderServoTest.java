...
public class encoderServoTest extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        yAxisDC.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        yAxisDC.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
...
//                }
            ...
            telemetry.addData("mm: ", (yAxisDC.getCurrentPosition()/13));
            telemetry.update();
